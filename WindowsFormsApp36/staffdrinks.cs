...
namespace WindowsFormsApp36
{
    public partial class staffdrinks : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'rESTURANTDATABASE2DataSet74.staffdrink' table. You can move, or remove it, as needed.
            this.staffdrinkTableAdapter6.Fill(this.rESTURANTDATABASE2DataSet74.staffdrink);
            // TODO: This line of code loads data into the 'rESTURANTDATABASE2DataSet73.admindrinks' table. You can move, or remove it, as needed.
            this.admindrinksTableAdapter3.Fill(this.rESTURANTDATABASE2DataSet73.admindrinks);
        ...
        private void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand com= new SqlCommand("Select productid,productname,productprice from admindrinks where productid=@productid",con);
